  ...
  return (
    ...
    <CategoryNav 
      ...
      <div className='py-4 text-gray-600 px-4'>
        Showing {pagination.totalBooks > 0 ? (pagination.currentPage - 1) * filters.limit + 1 : 0} - <span>
          {Math.min(pagination.currentPage * filters.limit, pagination.totalBooks)} of {pagination.totalBooks} books
        </span>
      </div>
